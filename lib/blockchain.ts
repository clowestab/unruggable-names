// Generated by @wagmi/cli@0.1.11 on 19/05/2023 at 18:28:32
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x0AF5319bEBffe6Af35b37559EfBcb625c3F2ffDA)
 * -
 */
...
export function useRenewalController(
  ...
  console.log("lastRenewalPriceIndex REDO CONFIG", config);
...
export function useRenewalControllerRead<TFunctionName extends string, TSelectData = ReadContractResult<typeof renewalControllerABI, TFunctionName>>(
  ...
  console.log("lastRenewalPriceIndex CONFIG", config);

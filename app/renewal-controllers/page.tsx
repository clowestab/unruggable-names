...
import { useGetRenewalControllers } from '@/lib/hooks/app/use-get-renewal-controllers'
  ...
  return (
    <section className="p-10">
      <div className="flex items-center justify-between">
        <h3 className="text-4xl font-normal">Renewal Controllers</h3>
...
const RenderUserTable = () => {
  const { user } = useUser()
  const { isLoading, isError, data } = useGetRenewalControllers(user)
